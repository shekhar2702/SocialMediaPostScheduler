...
- In order to run the application have rabbitmq and mysql server running and just build and run the spring boot application. The app will automatically create the required tables in the database and the required queues in rabbitmq.
